...
import { Box, Button, Chip, Dialog, DialogTitle, DialogContent, DialogActions, Typography, Divider, Stack } from '@mui/material';
...
export default function FeeReceiptListPage() {
  ...
  const fetchReceipts = async () => {
    setLoading(true);
    try {
      const response = await axiosInstance.get('/fees/receipts', {
            ...
            <Grid container spacing={2}>
              ...
              <Grid size={{ xs: 6 }}>
                ...
                <Typography variant="body1">
                  {selectedReceipt.studentName || 'N/A'}
                </Typography>
              </Grid>
              <Grid size={{ xs: 6 }}>
                <Typography variant="subtitle2" color="text.secondary">
                ...
                <Typography variant="body1">
                  {selectedReceipt.admissionNumber || 'N/A'}
                </Typography>
              </Grid>
              <Grid size={{ xs: 6 }}>
                <Typography variant="subtitle2" color="text.secondary">
